@extends('template')
@section('title', 'MCourt')
@section('content-title', 'MCourt')
@section('isi1')
<div class="col-md-10 text-dark " style="">
    <h1 style="color: black">MCourt</h1>

    <div class="col-md-7 mt-3 ps-5">
        <div class="card">
            <div class="card-header"><h1>Court</h1></div>
            <div class="card-body">
                <table class="table table-striped">
                    <thead>
                    <tr>
                        <th scope="col">No.</th>
                        <th scope="col">Court Type Id</th>
                        <th scope="col">Court Name</th>
                        <th scope="col">Action</th>
                    </tr>
                    </thead>
                    @forelse($court as $court)
                    <tbody>
                        <tr>
